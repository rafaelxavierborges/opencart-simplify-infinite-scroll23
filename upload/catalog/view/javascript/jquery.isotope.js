$("div.text-left, div.text-right").remove();
var IScroller = (function($){
    ...
    var _modOpts = {},
        ...
        _scrOptsMap = function(opts) {
            ...
            _scrOpts.loading.img = 'catalog/view/theme/default/image/iscroller-loader.gif';
        ...
        _create = function() {
            ...
            _scrOpts.loading.msg = $('<i id="infscr-loading" aria-hidden="true" style="display:none !important"></i>');
        ...
        _nearbottom = function() {
            return $(window).scrollTop() + $(window).height() + this.options.bufferPx 
                    > prodCont.offset().top + prodCont.height();
        },
        /**
        ...
        _onResize = function(){
            ...
            if (_barOpts.fitTo) {
                ...
                if (_barOpts.position === 'left') {
                    var left = elem.offset().left + parseInt(elem.css('padding-left'));
                    $scrollBar.css({left : left, right : 'auto'});
                } else {
                    var right = $(document).width() - elem.offset().left 
                              - elem.outerWidth() + parseInt(elem.css('padding-right'));
